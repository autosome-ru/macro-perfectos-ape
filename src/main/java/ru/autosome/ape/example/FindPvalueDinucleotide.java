...
public class FindPvalueDinucleotide {
  ...
  static void run_mono_and_di(PWM mono_pwm, BackgroundModel mono_background, Discretizer discretizer, double threshold) {
...
//    double[] thresholds = {3,5,7};
    ...
    run_mono_and_di(pwm, new WordwiseBackground(), discretizer, threshold);
    run_mono_and_di(pwm, new Background(new double[] {0.1, 0.4, 0.4, 0.1}), discretizer, threshold);
    run_mono_and_di(pwm, new Background(new double[] {0.25, 0.25, 0.25, 0.25}), discretizer, threshold);
  }
}
