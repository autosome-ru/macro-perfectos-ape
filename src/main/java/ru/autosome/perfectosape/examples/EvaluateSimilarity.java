...
public class EvaluateSimilarity {
  public static void main(String[] args){
    ...
    try {
      ...
      //System.out.println("\n----------\n" + new PWMAligned(firstPWMCounting, secondPWMCounting, similarityInfo.alignment).firstModelAligned);
      //System.out.println("\n----------\n" + new PWMAligned(firstPWMCounting, secondPWMCounting, similarityInfo.alignment).secondModelAligned);
        */
    } catch (Exception e) {
