...
import ru.autosome.perfectosape.calculation.SingleSNPScan.RegionAffinityInfos;
import ru.autosome.perfectosape.model.SequenceWithSNP;

public class SingleSNPScan extends SingleTask<RegionAffinityInfos> {
  ...
  public SingleSNPScan(Parameters parameters) {
    super();
    this.parameters = parameters;
  }

  ru.autosome.perfectosape.calculation.SingleSNPScan calculator() {
    return new ru.autosome.perfectosape.calculation.SingleSNPScan(parameters.pwm,
